...
from shared.utils.type_parser import TypeParser, TypeParseError, parse_type, is_syntactic_sugar, normalize_type
...
class TestTypeParser:
    ...
    def test_parse_string_with_length(self):
        ...
        test_cases = [
            ...
            ("string( 100 )", {"type": DataType.STRING.value, "max_length": 100}),  # with spaces
        ]
    ...
    def test_parse_float_with_precision_scale(self):
        """Test parsing float with precision and scale."""
        test_cases = [
            ("float(10,2)", {"type": DataType.FLOAT.value, "precision": 10, "scale": 2}),
            ("FLOAT(12,4)", {"type": DataType.FLOAT.value, "precision": 12, "scale": 4}),
            ("float( 8 , 3 )", {"type": DataType.FLOAT.value, "precision": 8, "scale": 3}),  # with spaces
            ("float(15,0)", {"type": DataType.FLOAT.value, "precision": 15, "scale": 0}),
        ]
    ...
    def test_parse_datetime_with_format(self):
        ...
        test_cases = [
            ("datetime('yyyymmdd')", {"type": DataType.DATETIME.value, "format": "yyyymmdd"}),
            ("DATETIME(\"yyyy-mm-dd\")", {"type": DataType.DATETIME.value, "format": "yyyy-mm-dd"}),
            ("datetime( 'dd/mm/yyyy hh:mm:ss' )", {"type": DataType.DATETIME.value, "format": "dd/mm/yyyy hh:mm:ss"}),
        ]
    ...
    def test_parse_detailed_format_backward_compatibility(self):
        """Test parsing detailed JSON format for backward compatibility."""
        test_cases = [
            ({"type": "string"}, {"type": DataType.STRING.value}),
            ({"type": "string", "max_length": 100}, {"type": DataType.STRING.value, "max_length": 100}),
            ({"type": "float", "precision": 10, "scale": 2}, {"type": DataType.FLOAT.value, "precision": 10, "scale": 2}),
            ({"type": "datetime", "format": "yyyy-mm-dd"}, {"type": DataType.DATETIME.value, "format": "yyyy-mm-dd"}),
        ]
    ...
    def test_metadata_validation(self):
        ...
        invalid_cases = [
            ({"type": "integer", "max_length": 10}, "max_length can only be specified for STRING type"),
            ({"type": "string", "precision": 5}, "precision/scale can only be specified for FLOAT type"),
            ({"type": "boolean", "scale": 2}, "precision/scale can only be specified for FLOAT type"),
            ({"type": "date", "format": "yyyy"}, "format can only be specified for DATETIME type"),
            ({"type": "string", "max_length": 0}, "max_length must be a positive integer"),
            ({"type": "float", "precision": 0}, "precision must be a positive integer"),
            ({"type": "float", "scale": -1}, "scale must be a non-negative integer"),
            ({"type": "float", "precision": 3, "scale": 5}, "scale cannot be greater than precision"),
        ]
    ...
    def test_is_syntactic_sugar(self):
    ...
    def test_normalize_to_detailed_format(self):
        """Test normalization to detailed format."""
        test_cases = [
            ("string(50)", {"type": "string", "expected_type": "STRING", "max_length": 50}),
            ("float(10,2)", {"type": "float", "expected_type": "FLOAT", "precision": 10, "scale": 2}),
            ({"type": "boolean"}, {"type": "boolean", "expected_type": "BOOLEAN"}),
        ]
...
class TestConvenienceFunctions:
    ...
    def test_is_syntactic_sugar_function(self):
...
class TestEdgeCases:
    ...
    def test_whitespace_handling(self):
        ...
        test_cases = [
            ...
            ("string(  50  )", {"type": DataType.STRING.value, "max_length": 50}),
            ("float( 10 , 2 )", {"type": DataType.FLOAT.value, "precision": 10, "scale": 2}),
            ("datetime( ' format ' )", {"type": DataType.DATETIME.value, "format": " format "}),
        ]
    ...
    def test_quote_variations(self):
        ...
        for input_type, expected_format in test_cases:
            result = TypeParser.parse_type_definition(input_type)
            assert result == {"type": DataType.DATETIME.value, "format": expected_format}

    def test_large_numbers(self):
        """Test handling of large numeric values."""
        test_cases = [
            ("string(65535)", {"type": DataType.STRING.value, "max_length": 65535}),
            ("float(38,10)", {"type": DataType.FLOAT.value, "precision": 38, "scale": 10}),
        ]
...
def test_acceptance_criteria_examples(input_type, expected):
